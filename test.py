...
# from exchange_calendars_extras.holiday_calendar import get_extended_class, ExtendedExchangeCalendar
#
...
import exchange_calendars_extras
from exchange_calendars_extras import ExtendedExchangeCalendar, apply_extensions

...
class TestHolidayCalendars:
    ...
    def test_get_holiday_calendar_from_day_of_week(self):
        ...
        assert pd.Timestamp("2019-01-07") in holidays.values
        assert pd.Timestamp("2019-01-14") in holidays.values
        assert pd.Timestamp("2019-01-21") in holidays.values
        assert pd.Timestamp("2019-01-28") in holidays.values
        assert pd.Timestamp("2019-01-01") not in holidays.values
        assert pd.Timestamp("2019-01-02") not in holidays.values
        assert pd.Timestamp("2019-01-03") not in holidays.values
        assert pd.Timestamp("2019-01-04") not in holidays.values
        assert pd.Timestamp("2019-01-05") not in holidays.values
        assert pd.Timestamp("2019-01-06") not in holidays.values
        assert pd.Timestamp("2019-01-08") not in holidays.values
        assert pd.Timestamp("2019-01-09") not in holidays.values
        assert pd.Timestamp("2019-01-10") not in holidays.values
        assert pd.Timestamp("2019-01-11") not in holidays.values
        assert pd.Timestamp("2019-01-12") not in holidays.values
        assert pd.Timestamp("2019-01-13") not in holidays.values
        assert pd.Timestamp("2019-01-15") not in holidays.values
        assert pd.Timestamp("2019-01-16") not in holidays.values
        assert pd.Timestamp("2019-01-17") not in holidays.values
        assert pd.Timestamp("2019-01-18") not in holidays.values
        assert pd.Timestamp("2019-01-19") not in holidays.values
        assert pd.Timestamp("2019-01-20") not in holidays.values
    ...
    def test_merge_calendars(self):
        ...
        assert pd.Timestamp("2019-01-19") not in holidays.values
        assert pd.Timestamp("2019-01-20") not in holidays.values
        assert pd.Timestamp("2019-01-22") not in holidays.values
        assert pd.Timestamp("2019-01-23") not in holidays.values
        assert pd.Timestamp("2019-01-24") not in holidays.values
        assert pd.Timestamp("2019-01-25") not in holidays.values

...
#     ece.add_special_close("TEST", pd.Timestamp("2023-07-03"), time(11, 0), "Added Special close")
...
#     # Special closes for regular special close time should be unchanged.
#     assert c.special_closes[0][0] == time(11, 0)
#     assert c.special_closes[0][1].holidays(start=start, end=end, return_name=True).compare(pd.Series({
#         pd.Timestamp("2022-05-02"): "Special close 0",
#         pd.Timestamp("2023-05-01"): "Special close 0",
#         pd.Timestamp("2023-07-03"): "Added Special close",
#         pd.Timestamp("2024-05-01"): "Special close 0"})).empty

#     # Added special close should not be in ad-hoc special closes, i.e. this should be unmodified.
#     assert c.special_closes_adhoc == [(time(11, 00), pd.Timestamp("2023-06-01"))]

#     # Added special close should be in consolidated calendar.
#     assert c.special_closes_all.holidays(start=start, end=end, return_name=True).compare(pd.Series({
#         pd.Timestamp("2022-05-02"): "Special close 0",
#         pd.Timestamp("2023-05-01"): "Special close 0",
#         pd.Timestamp("2023-06-01"): "ad-hoc special close",
#         pd.Timestamp("2023-07-03"): "Added Special close",
#         pd.Timestamp("2024-05-01"): "Special close 0"})).empty
...
#     ece.add_special_close("TEST", pd.Timestamp("2023-05-01"), time(12, 0), "Added Special close")
...
#     # There should be a new calendar for the added special close time.
#     assert c.special_closes[1][0] == time(12, 0)
#     assert c.special_closes[1][1].holidays(start=start, end=end, return_name=True).compare(pd.Series({
#         pd.Timestamp("2023-05-01"): "Added Special close"})).empty
...
#     assert c.special_closes_all.holidays(start=start, end=end, return_name=True).compare(pd.Series({
#         pd.Timestamp("2022-05-02"): "Special close 0",
#         pd.Timestamp("2023-05-01"): "Added Special close",
#         pd.Timestamp("2023-06-01"): "ad-hoc special close",
#         pd.Timestamp("2024-05-01"): "Special close 0"})).empty
...
#     add_test_calendar_and_apply_extensions(special_closes=[(time(11, 00), [pd.Timestamp("2023-05-01")]), (time(12, 00), [pd.Timestamp("2023-05-04")])])
#     import exchange_calendars as ec
#     import exchange_calendars_extensions as ece
...
#     assert c.special_closes[1][0] == time(12, 0)
#     assert c.special_closes[1][1].holidays(start=start, end=end, return_name=True).compare(pd.Series({
#         pd.Timestamp("2022-05-04"): "Special close 0",
#         pd.Timestamp("2023-05-04"): "Special close 0",
#         pd.Timestamp("2024-05-06"): "Special close 0"})).empty
...
#         pd.Timestamp("2023-05-04"): "Special close 0",
#         pd.Timestamp("2023-06-01"): "ad-hoc special close",
#         pd.Timestamp("2024-05-01"): "Special close 0",
#         pd.Timestamp("2024-05-06"): "Special close 0"})).empty
...
#     ece.add_special_close("TEST", pd.Timestamp("2023-06-01"), time(12, 0), "Added Special close")
...
#     assert c.special_closes[1][0] == time(12, 0)
#     assert c.special_closes[1][1].holidays(start=start, end=end, return_name=True).compare(pd.Series({
#         pd.Timestamp("2023-06-01"): "Added Special close"})).empty
...
#         pd.Timestamp("2022-05-02"): "Special close 0",
#         pd.Timestamp("2023-05-01"): "Special close 0",
#         pd.Timestamp("2023-06-01"): "Added Special close",
#         pd.Timestamp("2024-05-01"): "Special close 0"})).empty
...
#     ece.add_special_close("TEST", pd.Timestamp("2023-06-01"), time(11, 0), "Added Special close")
...
#     ece.remove_special_close("TEST", pd.Timestamp("2023-05-01"))
...
#     ece.remove_special_close("TEST", pd.Timestamp("2023-06-01"))
